...
public class CSVImportService : ICSVImportService
{
    ...
    {
        var data = JsonConvert.DeserializeObject(weeklyData.ToString());
    ...
    public async Task<string> GetTableHeadersStringAsync(Guid? id)
    {
        ...
        if (doc != null)
        {
            var jsonDoc = JsonConvert.DeserializeObject(doc["data"].AsBsonValue.ToString());
            return JsonConvert.SerializeObject(new { data = jsonDoc });
        }
        return string.Empty;
    }
